  ...
  */
  ...
  _createClass(colorPicker, [{
    ...
    */
    ...
    key: "_update",
    value: function _update(color, changes) {
  ...
  */
  ...
  _createClass(svgElement, [{
    ...
    */
    ...
    key: "setGradient",
    value: function setGradient(attr, gradient) {
      var attrs = {};
...
var svgGradient = function () {
  ...
  */
  function svgGradient(root, type, stops) {
...
var svgRoot = function (_svgElement) {
  _inherits(svgRoot, _svgElement);
  ...
  */
  function svgRoot(parent, width, height, display) {
    ...
    var _this = _possibleConstructorReturn(this, (svgRoot.__proto__ || Object.getPrototypeOf(svgRoot)).call(this, null, parent, "svg", {
      width: width,
      height: height,
  ...
  _createClass(svgRoot, [{
    ...
    key: "updateUrls",
    value: function updateUrls(base) {
      if (IS_SAFARI) {
