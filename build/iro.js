...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/iro.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _ui_marker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ui/marker */ "./src/ui/marker.js");
/* harmony import */ var _ui_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ui/slider */ "./src/ui/slider.js");
/* harmony import */ var _ui_wheel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ui/wheel */ "./src/ui/wheel.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  ColorPicker: function ColorPicker(el, props) {
    return Object(preact__WEBPACK_IMPORTED_MODULE_0__["render"])(React.createElement(modules_colorPicker__WEBPACK_IMPORTED_MODULE_1__["default"], null), document.querySelector(el))._component;
  },
  Stylesheet: modules_stylesheet__WEBPACK_IMPORTED_MODULE_3__["default"],
  ui: {
    Marker: _ui_marker__WEBPACK_IMPORTED_MODULE_4__["default"],
    Slider: _ui_slider__WEBPACK_IMPORTED_MODULE_5__["default"],
    Wheel: _ui_wheel__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
...
function (_Component) {
  ...
  function ColorPicker(props) {
    ...
    _this.color = new modules_color__WEBPACK_IMPORTED_MODULE_3__["default"](props.color);
    _this.state = {
      hsv: {
        h: 0,
        s: 0,
  ...
  _createClass(ColorPicker, [{
    ...
    */
    ...
    key: "setHsv",
    value: function setHsv(hsv, changes) {
      this.color.hsv = hsv;
      this.setState({
        hsv: hsv
      });
    ...
    */
    ...
    value: function render(props, state) {
      ...
      return React.createElement("svg", {
        ...
        rel: "aaa"
      }), React.createElement(ui_wheel__WEBPACK_IMPORTED_MODULE_1__["default"], _extends({
        hsv: state.hsv,
        x: 0,
        y: 0,
        radius: 100,
...
function (_Component) {
  ...
  _createClass(IroComponent, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      if (this.root) Object(util_dom__WEBPACK_IMPORTED_MODULE_1__["listen"])(this.root, [EVENT_MOUSEDOWN, EVENT_TOUCHSTART], this, {
        passive: false
      });
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      if (this.root) Object(util_dom__WEBPACK_IMPORTED_MODULE_1__["unlisten"])(this.root, [EVENT_MOUSEDOWN, EVENT_TOUCHSTART], this);
    }
  }, {
    key: "handleEvent",
    value: function handleEvent(e) {
      var root = this.root; // Detect if the event is a touch event by checking if it has the `touches` property
    ...
    key: "input",
    value: function input(x, y, rect, type) {}
  }]);
  ...
  _createClass(IroSlider, [{
    ...
    value: function render(props) {
      ...
      return React.createElement("svg", {
        ...
        offset: "100%",
        "stop-color": "hsl(".concat(hsl.h, ", ").concat(hsl.s, "%, ").concat(hsl.v, "%)")
      ...
      }), React.createElement(ui_marker__WEBPACK_IMPORTED_MODULE_2__["default"], {
