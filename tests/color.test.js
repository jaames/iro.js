...
test('iro.Color is a constructor', () => {
...
test('iro.Color can be constructed with an rgb or rgba string', () => {
...
test('iro.Color can be constructed with an rgb or rgba percentage string', () => {
...
test('iro.Color can be constructed with an hsl or hsla string', () => {
...
test('iro.Color can be constructed with a hex3 value', () => {
...
test('iro.Color can be constructed with a hex4 value', () => {
...
test('iro.Color can be constructed with a hex6 value', () => {
...
test('iro.Color can be constructed with a hex8 value', () => {
...
test('iro.Color clone method returns a new color with the same value', () => {
...
test('iro.Color set method successfully updates the color value', () => {
  const color = new Color({h: 0, s: 100, v: 100, a: 1});
  color.set({h: 360, s: 0, v: 0, a: 0});
  expect(color.hsv).toMatchObject({h: 360, s: 0, v: 0, a: 0});
});

test('iro.Color setChannel method successfully sets hsv channels', () => {
...
test('iro.Color setChannel method successfully sets rgb channels', () => {
...
test('iro.Color accepts and fires _onChange callback', done => {
...
test('iro.Color _onChange callback receives color and changes params', done => {
  const color = new Color({ h: 360, s: 100, v: 100, a: 1 });
...
test('iro.Color _onChange changes param provides an accurate diff or color changes', done => {
  const color = new Color({ h: 360, s: 100, v: 100, a: 1 });
  color._onChange = function(color, changes) {
