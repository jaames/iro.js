...
test('colorUtils parseUnit() parses CSS ints', () => {
...
test('colorUtils parseUnit() parses CSS percentages', () => {
...
test('colorUtils parseHexInt() converts hex strings to ints', () => {
...
test('colorUtils intToHex() converts an int to a 2-char hex str', () => {
